                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="main-title">
                           ...
                           <h6>All medias for royalties to be paid</h6>
                        </div>
                     </div>
                        ...
                        <tbody id="setData">
                           @if(isset($medias))
                              @foreach ($medias as $media)
                                    ...
                                    <tr>
                                       <td>{{$media->title}}</td>
                                       <td>{{$media->channel->user->email ?? ''}}</td>
                                       <td>{{$media->tags}}</td>
                                       <td><a>{{$media->channel->title}}</a></td>
                                       <td>{{ $media->royalties}}</td>
                                        <td><a href="/admin/paid/{{$media->id}}"><button class="btn btn-danger js-delete" data-user-id="user.Id">Confirm Paid</button></a></td>
                                    </tr>
